...
HD_PWD='C:/Users/muzer/Desktop/EEE4120F/YODA/RTL/Image_Proc/Image_Proc.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log MedianFilter.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source MedianFilter.tcl
